...
# Database's data
db_namn = 'pizzeria.db'
path = 'Utveckling av webbapplikationer/Flask/secondo tentativo/'
...
def DataFromKb(table, name, mail, password, admin):
    '''
    table = name of the table into the database
    '''
    md = table(
...
DataFromKb(Users, 'prova', 'prova@prova.it', 'prova', 0)
